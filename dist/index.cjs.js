...
var fixedStyle = styled.css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    position: fixed;\n    top: 0;\n    right: 0;\n    left: 0;\n    z-index: 50\n"])));
var Navbar = styled__default['default'].nav(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    display: flex;\n    flex-direction: column;\n    border-bottom: 1px solid ", ";\n    background: #fff;\n    ", "\n"])), BORDER_COLOR, function (props) {
  return props.fixed ? fixedStyle : "";
});
var Action = styled__default['default'].button(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    border: none;\n    background-color: #fff;\n    width: 50px;\n    transition: background-color 0.5s;\n    svg {\n        width: 23px;\n    }\n    &:hover {\n        background-color: #000;\n        svg {\n            stroke: #fff;\n        }\n    }\n"])));
var StyledAirplane = styled__default['default'](Airplane)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n    width: 18px;\n"])));
...
var StyledStatuBar = styled__default['default'](StatuBar)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    display: flex;\n    justify-content: space-between;\n    border-bottom: 1px solid #000;\n    padding: 3px 18px;\n    height: 19px;\n    .statu-item {\n        margin-left: 10px;\n    }\n    .time {\n        transform: scaleY(-50%);\n    }\n"])));
var StyledActionBar = styled__default['default'](ActionBar)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n    display: flex;\n    height: 50px;\n"])));
/**
 * Navbar组件
...
var index$1 = (function (_ref3) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Navbar, {
    fixed: autoClose
  }, /*#__PURE__*/React__default['default'].createElement(StyledStatuBar, null, /*#__PURE__*/React__default['default'].createElement("div", {
